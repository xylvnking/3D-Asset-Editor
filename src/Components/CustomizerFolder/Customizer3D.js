...
export default function Customizer3D(props) {
    ...
    const toggleWireframeAlsoTextureOff = () => {
        if (!toggleTexture1) {
            setWireFrameToggle1(!wireframeToggle1)
            setToggleTexture1(true)
            setToggleMesh1Visibility(true)
        } else {
            setWireFrameToggle1(!wireframeToggle1)
            setToggleTexture1(false)
            setToggleMesh1Visibility(true)
                    ...
                    <div className={customizerControls}>
                        ...
                        <div className={uiMeshControls}>
                            <div className={uiPremadeTextureSelectors}>  
                                <button
                                    className={toggleTexture1 ? uiPremadeTextureButton : uiPremadeTextureButtonPressed}
                                    onClick={() => 
                                    setToggleTexture1(!toggleTexture1)}>
                                        {toggleTexture1 ? <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40"><path d="M7.083 36.083q-1.291-.333-2-1.125-.708-.791-1.083-2.041l28.917-29q1.166.291 2.021 1.146.854.854 1.104 2.02Zm-3.291-10v-6.375L19.708 3.75h6.375Zm0-13.375v-4.5q0-1.833 1.291-3.146Q6.375 3.75 8.208 3.75h4.5Zm23.5 23.5 8.958-8.916v4.5q0 1.833-1.312 3.125-1.313 1.291-3.146 1.291Zm-13.375 0L36.25 13.917v6.375L20.292 36.208Z"/></svg> : <svg xmlns="http://www.w3.org/2000/svg" height="40" width="40"><path d="M32.167 15.083 29.875 10l-5.167-2.292 5.167-2.291L32.167.5l2.166 4.917L39.5 7.708 34.333 10Zm0 24.334L29.875 34.5l-5.167-2.292 5.167-2.25 2.292-5.125 2.166 5.125 5.167 2.25-5.167 2.292ZM14.5 33.792l-4.417-9.459-9.625-4.375 9.625-4.333 4.417-9.5 4.417 9.5 9.541 4.333-9.541 4.375Z"/></svg>}
                                    Texture 1
                                </button>
                                <button
                                    className={toggleTexture2 ? uiPremadeTextureButton : uiPremadeTextureButtonPressed}
                                    onClick={() => 
                                    setToggleTexture2(!toggleTexture2)}>
                                    Texture 2
                                </button>
                                <button
                                    className={toggleTexture3 ? uiPremadeTextureButton : uiPremadeTextureButtonPressed}
                                    onClick={() => 
                                    setToggleTexture3(!toggleTexture3)}>
                                    Texture 3
                                </button>
                                <button
                                    className={toggleTexture4 ? uiPremadeTextureButton : uiPremadeTextureButtonPressed}
                                    onClick={() => 
                            ...
                            <div className={uiMaterialControls}>
                                <HexColorPicker 
                                    ...
                                    // onMouseLeave={() => setToggleTexture1(true)}
                                    />
